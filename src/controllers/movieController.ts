...
import { NewMovieRequestBody, SearchRequestQuery } from "../types/type.js";
import { MovieModel } from "../models/movie.js";

export const createMovie = async (req: Request<{}, {}, NewMovieRequestBody>, res: Response, next: NextFunction) => {
    try {
...
export const getMovieByQuery = async (req: Request<{}, {}, {}, SearchRequestQuery>, res: Response, next: NextFunction) => {
    try {
